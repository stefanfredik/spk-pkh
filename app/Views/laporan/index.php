...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#datablt" type="button" role="tab" aria-controls="profile" aria-selected="false">Data Penerima PKH</button>
    </li>
...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show " id="datapenduduk" role="tabpanel" aria-labelledby="home-tab">
        ...
        <hr>
        <div class="row">
            <?= $this->include("laporan/datapenduduk"); ?>
        </div>
    </div>
